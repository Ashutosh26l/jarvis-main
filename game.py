...
smallrock=ImageTk.PhotoImage(Image.open("smallrock.png"))
smallpaper=ImageTk.PhotoImage(Image.open("smallpaper.png"))
smallscissor=ImageTk.PhotoImage(Image.open("smallscissor.png"))
